                                ...
                                <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                                    <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                        <img src="<?php echo $person["img"];?>" alt="Sunny A." class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                            <div class="ml-2 mr-3">
                                                <h5 class="m-0">
                                                <?php echo $person["name"];?> (<?php echo $person["status"];?>)
                                                    <small class="m-0 fw-300">
                                                    <?php echo $person["post"];?>
                                                    </small>
                                                </h5>

                                                <a href="<?php echo $person["twitter"];?>" class="text-info fs-sm" target="_blank">@myplaneticket</a> 
                                                -
                                                <a href="<?php echo $person["about"];?>" class="text-info fs-sm" target="_blank" title="Contact Sunny"><i class="fal fa-envelope"></i></a>
                                            </div>
                                    </div>
                                </div>
                           <?php endforeach;?>
