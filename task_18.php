                        ...
                        <div class="panel-container show">
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                        ...
                                        <form action="answers/answer_17.php?page=task_18" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <?php foreach($img_path as $img): ?>
                                            <div class="col-md-3 image">
                                                ...
                                                <a class="btn btn-danger" href="answers\answer_delete_img_18.php?id=<?php echo $img['id'];?>" onclick="confirm('Вы уверены?');">Удалить</a>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
